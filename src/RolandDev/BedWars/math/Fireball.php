...
class Fireball extends Throwable {
    ...
    public function attack(EntityDamageEvent $source) : void{
		...
		if($source instanceof EntityDamageByEntityEvent){
			 ...
			 $this->setMotion($damager->getDirectionVector()->add(0)->multiply(0.5));
		}
	}
	...
	public function explode(): void{
		...
		$ev->call();
		if(!$ev->isCancelled()){
			$explosion = new Explosion(Position::fromObject($this->add(0, $this->height / 2), $this->level), $ev->getForce(), $this);
