...
use RolandDev\BedWars\math\Math;
...
class EnderDragon extends Living {
     ...
     * @param string $color
     */
    public function __construct(Level $level, CompoundTag $nbt, DragonTargetManager $targetManager,string $color) {
    ...
    public function move(float $dx, float $dy, float $dz): void {
        ...
        if($this->keepMovement){
            ...
            foreach ($list as $bb) {
                $blocks = $this->level->getBlockAt((int)$bb->minX, (int)$bb->minY, (int)$bb->minZ);
